...
public class MatchLeagueFragment extends AbstractBaseFragment {
    public static final String TAG = "MatchLeagueFragment";
    private FragmentMatchLeagueBinding binding;
    ...
    protected void createView(ViewDataBinding viewDataBinding) {
        binding = (FragmentMatchLeagueBinding)viewDataBinding;
        binding.setMatchLeagueFragment(this);
