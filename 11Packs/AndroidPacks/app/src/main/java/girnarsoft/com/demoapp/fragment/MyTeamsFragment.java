...
import girnarsoft.com.demoapp.databinding.FragmentMyTeamBinding;
...
public class MyTeamsFragment extends AbstractBaseFragment {
    public static final String TAG = "MyTeamsFragment";
    ...
    protected void createView(ViewDataBinding viewDataBinding) {
        binding = (FragmentMyTeamBinding)viewDataBinding;
        binding.setMyTeamFragment(this);
    }
