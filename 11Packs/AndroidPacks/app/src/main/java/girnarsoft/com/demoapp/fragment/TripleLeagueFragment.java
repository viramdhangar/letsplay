...
import girnarsoft.com.demoapp.databinding.FragmentTripleLeagueBinding;
...
public class TripleLeagueFragment extends AbstractBaseFragment {
    public static final String TAG = "TripleLeagueFragment";
    private FragmentTripleLeagueBinding binding;
    private LeagueRecyclerAdapter adapter;
    @Override
    protected int getFragmentLayout() {
        return R.layout.fragment_triple_league;
    }

    @Override
    protected void createView(ViewDataBinding viewDataBinding) {
        binding = (FragmentTripleLeagueBinding)viewDataBinding;
        binding.setTripleLeagueFragment(this);
    }
    ...
    private void fetchMatcheLeaguesList(String matchId){
        ...
        if (null != service) {
            service.getMatchLeagueList(getContext(), matchId, PacksConstants.LeagueType.TRIPLE_LEAGUE, new AbstractViewCallback<LeagueViewModel>() {
